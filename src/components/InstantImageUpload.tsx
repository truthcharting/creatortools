...
export function InstantImageUpload({ onBack }: InstantImageUploadProps) {
    ...
    <div className="min-h-screen bg-background pt-safe pb-20">
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <div className="flex items-center justify-between p-4">
          ...
          <h1 className="text-xl font-bold">Instant Image Upload</h1>
      ...
      <div className="p-4 space-y-6">
        ...
        <Card className="border-2 border-gray-200">
          ...
          <CardContent className="space-y-4">
            ...
            <Button 
              ...
              className="w-full h-16 text-lg font-semibold bg-gray-600 hover:bg-gray-700"
            ...
            {photos.length > 0 && (
              <div className="text-center">
                <Badge variant="outline" className="text-base px-4 py-2 border-gray-300 text-gray-700">
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-green-800">Images Saved!</p>
        ...
        <Card className="border-dashed border-gray-300">
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>• Tap "Choose Images" to select from your photo roll</p>
            <p>• You can select multiple images at once</p>
            <p>• Images are automatically saved with timestamp and location</p>
            <p>• View all uploaded images in the Notes screen</p>
          </CardContent>
        </Card>
      </div>
    </div>
